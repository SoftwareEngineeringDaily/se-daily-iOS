...
class LoginViewController: UIViewController {
  ...
  private func setupTextFields() {
    ...
    let height = UIView.getValueScaledByScreenWidthFor(baseValue: 40)
    ...
    emailTextField.font = UIFont(name: "OpenSans-SemiBold", size: UIView.getValueScaledByScreenWidthFor(baseValue: 15))
    ...
    usernameTextField.font = UIFont(name: "OpenSans-SemiBold", size: UIView.getValueScaledByScreenWidthFor(baseValue: 15))
    ...
    passwordTextField.font = UIFont(name: "OpenSans-SemiBold", size: UIView.getValueScaledByScreenWidthFor(baseValue: 15))
    ...
    passwordConfirmTextField.font = UIFont(name: "OpenSans-SemiBold", size: UIView.getValueScaledByScreenWidthFor(baseValue: 15))
  ...
  private func setupButtons() {
    let width = UIView.getValueScaledByScreenWidthFor(baseValue: 316)
    let height = UIView.getValueScaledByScreenWidthFor(baseValue: 60)
    ...
    submitButton.cornerRadius = UIView.getValueScaledByScreenWidthFor(baseValue: 6)
    ...
    toggleButton.titleLabel?.font = UIFont(name: "OpenSans", size: UIView.getValueScaledByScreenWidthFor(baseValue: 14))
